...
// Copyright (c) 2014-2015 The Corgicoin Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Corgicoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // Corgicoin: load fallback font in case Comic Sans is not availble on the system
    ...
    // Corgicoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Corgicoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Corgicoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and corgicoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Corgicoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Corgicoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Corgicoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Corgicoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Corgicoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Corgicoin Core help message to get a list with possible Corgicoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Corgicoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Corgicoin"); // default title
