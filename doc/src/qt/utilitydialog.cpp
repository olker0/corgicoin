    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Corgicoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Corgicoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  corgicoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Corgicoin Core is shutting down...") + "<br /><br />" +
