...
public:
    CMainParams() {
        ...
        digishieldConsensus.nHeightEffective = 330000;
        ...
        genesis.nNonce   = 1112448;

        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0x80e8f750bbc1ffc3ec396227281bdb8963ec4eb0e3fadcd0b2808150edc7b5b7"));
        assert(genesis.hashMerkleRoot == uint256S("0xfd5e2484e1fcbc901e14673811998197fb2dc6bbc83b51b1c41d7e15f63158ae"));

		// vSeeds.push_back(CDNSSeedData("seed.corgicoin.com", "seed.corgicoin.com"));
        // vSeeds.push_back(CDNSSeedData("seed.vannatter.com", "seed.vannatter.com"));
        // vSeeds.push_back(CDNSSeedData("corgicoin.com", "seed.corgicoin.com"));
        ...
        // vSeeds.push_back(CDNSSeedData("doger.corgicoin.com", "seed.doger.corgicoin.com"));
        ...
        // vSeeds.push_back(CDNSSeedData("82.200.205.30", "82.200.205.30"));
        vSeeds.push_back(CDNSSeedData("47.92.230.38", "47.92.230.38"));
        //vSeeds.push_back(CDNSSeedData("43.243.168.104", "43.243.168.104"));
        //vSeeds.push_back(CDNSSeedData("47.95.194.175", "47.95.194.175"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);  // 0x1e
        ...
        //TODO: fix this for corgicoin -- plddr
        ...
        checkpointData = (Checkpoints::CCheckpointData) {
            ...
            (      0, uint256S("0x80e8f750bbc1ffc3ec396227281bdb8963ec4eb0e3fadcd0b2808150edc7b5b7")),
