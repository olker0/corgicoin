...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Corgicoin Core corgicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  corgicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded corgicoin transaction") + "\n" +
              "  corgicoin-tx [options] -create [commands]   " + _("Create hex-encoded corgicoin transaction") + "\n" +
              "\n";
