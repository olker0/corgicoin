        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Corgicoin: Disable free transactions
...
{
    // Corgicoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Corgicoin: Add an increased fee for each dust output
        nFeeNeeded += GetCorgicoinDustFee(tx.vout, minTxFee);
    }
